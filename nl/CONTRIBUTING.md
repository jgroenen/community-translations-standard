...
opmerking: "In verband met de overgang van de governance is dit bestand verouderd en moet derhalve worden herzien; hier en in de upstream."
---
...
Een standaard als deze alleen kan worden vastgesteld in samenwerking met zoveel mogelijk technologen uit de publieke sector, beleidsmakers en geïnteresseerden. We waarderen daarom uw inbreng, stellen uw feedback op prijs, verwelkomen verbeteringen aan dit project en staan erg open voor samenwerking.

We houden van issues en pull requests van iedereen. Als u niet vertrouwd bent met GitHub, kunt u uw feedback mailen naar <johan@codefor.nl>.

## Problemen, suggesties en vragen in kwesties

Een globaal overzicht van de ontwikkeling die we al hebben geschetst, vindt u in de routekaart. Help de ontwikkeling door problemen te melden, wijzigingen voor te stellen en vragen te stellen. Om dit te doen, kunt u een GitHub-issue aanmaken voor dit project in de GitHub-issues voor de *Standaard voor Publieke Code*.
